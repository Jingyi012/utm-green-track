      ...
      <ProCard
        title={
          <Title level={4} style={{ margin: 0 }}>
            About GREENTRACK SYSTEM
          </Title>
        }
      >
        <Paragraph style={{ fontSize: 16, lineHeight: 1.6, textAlign: 'justify' }}>
          ...
          ensuring accurate and reliable internal reporting. This system enables the university to
          monitor its sustainability progress effectively and strengthen its commitment to a greener
          future.
        </Paragraph>

        <Title level={1} style={{ textAlign: 'center', margin: '30px' }}>
          Get Started!
        </Title>
